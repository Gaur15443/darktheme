  ...
  return (
    <TouchableOpacity
      ...
      hitSlop={
        clickableAreaSize
          ? {
              top: clickableAreaSize?.top,
              bottom: clickableAreaSize?.bottom,
              left: clickableAreaSize?.left,
              right: clickableAreaSize?.right,
            }
          : {}
      }
      accessible={true}>
...
const styles = StyleSheet.create({
  ...
  line: {
    ...
    backgroundColor: 'black',
    marginVertical: 1.5,
    borderRadius: 2, // Make lines look cleaner with rounded ends
  },
});
